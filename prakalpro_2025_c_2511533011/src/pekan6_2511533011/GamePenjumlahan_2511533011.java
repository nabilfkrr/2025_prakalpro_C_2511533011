...
public class GamePenjumlahan_2511533011 {
	...
	public static void main(String[] args) {
		...
		int wrong = 0;
		while (wrong < 3) {
			int result = play(consule, rand);	// play one game
			if (result > 0) {
				points++;
			} else {
				wrong++;
	...
	public static int play(Scanner consule, Random rand) {
